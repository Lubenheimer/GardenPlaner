          ...
          : `<div class="planting-list">
              ${plantings.map(p => {
                ...
                <div class="planting-item">
                  ...
                  <button class="btn btn-sm planting-perennial-btn" data-planting-id="${p.id}" data-perennial="${!!p.isPerennial}"
                    title="Ist Staude / überwintert" style="padding: 2px 6px; font-size: 11px; min-width: 0; filter: ${p.isPerennial ? 'none' : 'grayscale(1) opacity(0.4)'};">
                    ❄️
                  </button>
