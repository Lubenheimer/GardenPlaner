...
export const plants = [
  ...
  { name: 'Bärlauch', emoji: '🌿', category: 'Kräuter', sowMonth: [9,10,11], harvestMonth: [3,4,5], spacing: 20, daysToHarvest: 180, waterDays: 3 },
  { name: 'Waldmeister', emoji: '🌿', category: 'Kräuter', sowMonth: [9,10], harvestMonth: [4,5], spacing: 20, daysToHarvest: 180, waterDays: 4 },
  { name: 'Sauerampfer', emoji: '🌿', category: 'Kräuter', sowMonth: [3,4,8], harvestMonth: [5,6,7,8,9,10], spacing: 20, daysToHarvest: 60, waterDays: 3 },
  ...
  { name: 'Apfelbaum', emoji: '🍎', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [8,9,10], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Birnbaum', emoji: '🍐', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [8,9,10], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Kirschbaum', emoji: '🍒', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [6,7], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Pflaumenbaum', emoji: '🍑', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [7,8,9], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Pfirsichbaum', emoji: '🍑', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [7,8], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Quitte', emoji: '🍋', category: 'Obst', sowMonth: [10,11,3,4], harvestMonth: [10,11], nutrition: 'stark', spacing: 300, daysToHarvest: 1000, waterDays: 7, fertilizeWeeks: 12 },
  { name: 'Feige', emoji: '🟤', category: 'Obst', sowMonth: [3,4,5], harvestMonth: [8,9,10], nutrition: 'stark', spacing: 200, daysToHarvest: 365, waterDays: 5, fertilizeWeeks: 8 },
  { name: 'Mini-Kiwi', emoji: '🥝', category: 'Obst', sowMonth: [3,4,5], harvestMonth: [9,10], nutrition: 'stark', spacing: 150, daysToHarvest: 730, waterDays: 4, fertilizeWeeks: 4 },
